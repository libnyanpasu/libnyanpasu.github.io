...
export default withMermaid({
  ...
  mermaidPlugin: {
    class: 'mermaid flex justify-center' // set additional css classes for parent container
  },
  ...defineConfig({
          ...
          sidebar: [
            { text: 'Home', link: '/' },
            {
              ...
              items: [
                ...
                {
                  text: 'Chain Examples',
                  link: '/tutorial/chains/custom-rules'
                }
              ]
            },
            {
          ...
          sidebar: [
            { text: '主页', link: '/zh-CN/' },
            {
              ...
              items: [
                ...
                {
                  text: '代理链示例',
                  link: '/zh-CN/tutorial/chains/custom-rules'
                }
              ]
            },
            {
