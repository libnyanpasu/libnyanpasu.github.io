...
import { cn, chains } from "@/lib/utils";
...
export interface ButtonProps
  extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "disabled">, ButtonVariantsProps {
  asChild?: boolean;
  loading?: boolean;
}
...
export const Button = ({
  ...
  const handlePointerDown = disabled ? undefined : chains(onPointerDown, ripple.onPointerDown);
