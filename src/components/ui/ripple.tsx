...
import { AnimatePresence, clamp, domAnimation, LazyMotion, motion } from "motion/react";
import { type Key, type PointerEvent, useCallback, useState } from "react";
        ...
        return (
          <LazyMotion key={ripple.key} features={domAnimation}>
            <AnimatePresence mode="popLayout">
              <motion.span
                className="pointer-events-none absolute origin-center rounded-full"
...
export const useRipple = () => {
  ...
  return { ripples, onPointerDown, onClear };
};
